...
class CVCClinicDB_Dataset(data.Dataset):
    def __init__(self, dataset_type='train', transform=None):
        self.item_image = sorted(os.listdir("Dataset/PNG/Original"))
        self.item_gt = sorted(os.listdir("Dataset/PNG/GroundTruth"))
    ...
    def __getitem__(self, index):
        ...
        image = Image.open("Dataset/PNG/Original/" + img_name).convert("RGB")
        label = Image.open("Dataset/PNG/GroundTruth/" + label_name).convert("L")
